...
drop table CARTOON cascade constraints;
  ...
  CREATE TABLE "MOVIEEXEC" 
   ...
   Alter Table MovieExec Add (SpouseName VarChar2(30));
   Alter Table MovieExec Add (BirthDate Date);
   Alter Table MovieExec Add (Gender Char(6));
/
...
Insert into MOVIEEXEC (NAME,ADDRESS,CERTNO,NETWORTH) values ('denis villeneuve','Trois-Rivieres, Quebec, Canada',31,33560000);
